...
# default_configuration     = YAML.load(Rails.root.join('config', 'configr.yml'))
# environment_configuration = YAML.load(Rails.root.join('config', 'environments', "\#{Rails.env}.yml"))
